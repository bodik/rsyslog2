...
and shell acces to them.  All helpers take ENV['VMNAME'] as instance selector
or set a default one. All helpers provides basic subset of primitives:
...
(templates.*) for VM provisioning. Helper must initialize users credentials to /dev/shm:
