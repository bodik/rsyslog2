...
usage() { echo "Usage: $0 -d <THIN_TUN_DEV> -t <THIN_TUN_ADDRESS> -n <CORE_TUN_NUMBER> -c <CORE_PUBLIC_ADDRESS> -a <CORE_TUN_ADDRESS> -p <PORT>,<PORT>,..." 1>&2; exit 1; }
while getopts "d:t:n:c:a:p:" o; do
    case "${o}" in
        d)
            thin_tun_dev=${OPTARG}
            ;;
