...
TODO: elaborate on roles, check and check_stddev.s
...
Bootstrap suite from a git repository, subsequent calls would pull from master repo.
  ...
  wget esb3.metacentrum.cz/rsyslog2.git/bootstrap.install.sh && sh bootstrap.install.sh
  cd /puppet && ls -l
...
* rsyslog[link:puppet/rsyslog/README_full.html]
* rediser[link:puppet/rediser/README_full.html]
* elk[link:puppet/elk/README_full.html]
* jenkins[link:puppet/jenkins/README_full.html]
